# 🔧 Famartcorp Manager - Backend

## Laravel 12 REST API

Sistema backend completo para gerenciamento de consultores, equipes, celulares e números WhatsApp.

---

## ✅ Implementado

- ✅ **8 Migrations** com relacionamentos complexos
- ✅ **4 Models** (User, Equipe, Celular, WhatsappNumero)
- ✅ **4 Controllers CRUD** completos
- ✅ **4 Policies** para controle de acesso
- ✅ **25 Endpoints API** RESTful
- ✅ **Autenticação Sanctum** (cookie-based)
